                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('usuario_alterar', ['id' => $u->id])}}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" value="{{$u->nome}}" name="nome" id="f_nome" placeholder="name@example.com">
                            <label for="f_nome">Nome</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" value="{{$u->email}}" name="email" id="f_email" placeholder="name@example.com">
                            <label for="f_email">Email</label>
                          </div>
                        <div class="form-floating">
                            <input type="password" name="senha" value="{{$u->senha}}" class="form-control" id="f_senha" placeholder="Password">
